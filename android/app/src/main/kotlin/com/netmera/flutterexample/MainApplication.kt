...
class MainApplication : FlutterApplication() {
    ...
    override fun onCreate() {
        ...
        val fNetmeraConfiguration = FNetmeraConfiguration.Builder()
            ...
            .apiKey(sharedPreferences.getString("apiKey", BuildConfig.NETMERA_PREPROD_API_KEY)) // Your Netmera api key
            .baseUrl(sharedPreferences.getString("baseUrl", BuildConfig.NETMERA_PREPROD_BASE_URL)) // Netmera base url
